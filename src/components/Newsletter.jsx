...
export default function Newsletter() {
  ...
  return (
    <section id="newsletter" className="section-pad-dark" style={{ textAlign:"center", position:"relative", overflow:"hidden" }}>
      <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)",
        width:520, height:520, background:"radial-gradient(circle,rgba(184,151,62,0.07),transparent 70%)", pointerEvents:"none" }}/>
      <div style={{ position:"relative", zIndex:1 }}>
        ...
        <h2 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"clamp(2rem,4vw,3.8rem)", fontWeight:300, lineHeight:1.15, color:IVORY }}>
        ...
        {subscribed ? (
          ...
          <div className="newsletter-form">
            ...
            <button onClick={() => email.includes("@") && (setSubscribed(true), setEmail(""))}
              style={{ padding:"16px 28px", background:GOLD, border:`1px solid ${GOLD}`, color:OBSIDIAN,
                fontFamily:"'Jost',sans-serif", fontSize:"0.62rem", fontWeight:500,
                letterSpacing:"0.22em", textTransform:"uppercase", cursor:"pointer", transition:"background 0.3s", whiteSpace:"nowrap" }}
