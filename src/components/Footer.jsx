...
export default function Footer({ onNav, onService, onLegal }) {
  return (
    <footer style={{ background:OBSIDIAN, padding:"72px 64px 34px" }}>
      <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr", gap:52,
        paddingBottom:52, borderBottom:"1px solid rgba(255,255,255,0.06)", marginBottom:32 }}>
        ...
        <div>
          ...
          <p style={{ fontSize:"0.77rem", fontWeight:300, lineHeight:1.9, color:"rgba(249,245,239,0.26)",
            maxWidth:260, marginBottom:26 }}>A sanctuary for those who regard dressing as an art form. Luxury fashion since 1989.</p>
          <div style={{ display:"flex", gap:12 }}>
            {[["𝕏","https://twitter.com"],["in","https://linkedin.com"],["◎","https://instagram.com"],["⊕","https://pinterest.com"]].map(([icon, url]) => (
              <a key={url} href={url} target="_blank" rel="noreferrer"
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor=GOLD; e.currentTarget.style.color=GOLD; e.currentTarget.style.background="rgba(184,151,62,0.08)"; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor="rgba(255,255,255,0.1)"; e.currentTarget.style.color="rgba(255,255,255,0.32)"; e.currentTarget.style.background="transparent"; }}
              >{icon}</a>
            ))}
          </div>
        </div>
