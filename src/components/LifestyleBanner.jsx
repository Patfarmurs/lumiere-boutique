...
export default function LifestyleBanner({ onNav }) {
  return (
    <div id="lifestyle" style={{ position:"relative", height:"72vh", overflow:"hidden",
      ...
      <div style={{ position:"relative", zIndex:2, textAlign:"center", maxWidth:660, padding:"0 40px" }}>
        ...
        <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"clamp(1.8rem,3.2vw,3rem)",
