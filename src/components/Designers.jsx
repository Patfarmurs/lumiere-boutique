...
export default function Designers({ onNav }) {
  return (
    <section id="designers" className="section-pad" style={{ background:"#F9F5EF" }}>
      <div style={{ textAlign:"center", marginBottom:56 }}>
        ...
        <p style={{ fontSize:"0.86rem", fontWeight:300, lineHeight:1.9, color:WARM_GRAY, maxWidth:520, margin:"18px auto 0" }}>
          Every piece in the Lumière collection is the vision of a singular creative voice.
        </p>
      </div>

      <div className="designers-grid">
        {designers.map((d, i) => (
          <div key={i} className="designer-card">
            ...
            <div style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"clamp(1rem,2vw,1.25rem)", fontWeight:400, marginBottom:6 }}>{d.name}</div>
