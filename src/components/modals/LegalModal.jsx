  ...
  return (
    <div onClick={onClose} style={{ position:"fixed", inset:0, zIndex:2000,
      ...
      <div onClick={e => e.stopPropagation()} style={{
        background:IVORY, width:"100%", maxWidth:580, maxHeight:"82vh",
        overflowY:"auto", padding:"52px 48px", position:"relative" }}>
        ...
        <h3 style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:"2.2rem",
